...
import { User, Mail, Lock, ArrowRight, UserPlus, Phone, Loader2 } from "lucide-react";
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-5 py-12">
      ...
      >
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-black">Create Account</h2>
          <p className="mt-2 text-slate-400">Start your transformation today.</p>
        </div>
